...
INSERT INTO `__new_positions`(`id`, `receipt_id`, `offer_id`, `title`, `quantity`, `price`, `client_tag`) SELECT `id`, `receipt_id`, `offer_id`, `title`, `quantity`, `price`, `client_tag` FROM `positions`;--> statement-breakpoint
...
CREATE TABLE `__new_receipts` (
	...
	`client_tag` text,
	`created_at` integer DEFAULT 1788116248776 NOT NULL
);
--> statement-breakpoint
